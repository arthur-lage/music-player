...
export function Login() {
  return (
    <div
      className="min-h-[100vh] bg-gradient-to-b from-purple-200 flex items-center justify-center flex-col"
    >
      <h1 className="font-bold font-poppins text-4xl text-gray-900">Music Player</h1>

      <img className="w-[225px] my-16" src={HappyMusic} alt="Happy character listening to music" />
